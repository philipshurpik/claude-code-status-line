...
A color-coded status line for Claude Code CLI - context window usage, rate limits, project info, and git branch. Single JS file, 100 lines, no dependencies, no configuration, no extra fonts.
